...
{
    private const MIGRATION_VERSION = 'about-v14';
    ...
    public static function build_about_page_content(): string
    {
        $blocks = [
            ...
            Constructly_Migration_Helpers::block('constructly/page-hero', [
                ...
                'lead' => 'Независимый сервис строительных калькуляторов для частных застройщиков. Считаем по действующим нормам и показываем, из чего складывается результат.',
                'paragraphs' => [
            ...
            Constructly_Migration_Helpers::block('constructly/feature-cards', [
                ...
                'items' => [
                    [
                        ...
                        'text' => 'Развиваем сервис: добавляем новые калькуляторы и расширяем охват строительных задач.',
                    ],
                    [
                        'icon' => 'shield-check',
...
<table class="bm-norms-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Листы ГКЛ/ГКЛВ — типы, размеры, характеристики. Используется в калькуляторе гипсокартона.</td>
    </tr>
  </tbody>
</table>
</div>
