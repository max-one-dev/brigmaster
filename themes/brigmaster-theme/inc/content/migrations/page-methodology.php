...
{
    private const MIGRATION_VERSION = 'methodology-v5';
    ...
    public static function build_methodology_page_content(): string
    {
        $blocks = [
            Constructly_Migration_Helpers::block('constructly/page-hero', [
                ...
                'lead' => 'Здесь показано, как считает каждый калькулятор: по каким формулам, из каких нормативов взяты коэффициенты и какие допущения заложены. Никаких «чёрных ящиков» — любую цифру можно проверить.',
                'columns' => '4',
                'variant' => 'small-title',
                'features' => [
                    ['icon' => 'data-table', 'title' => 'Проверенные формулы и данные'],
                    ['icon' => 'document-add', 'title' => 'Актуальные нормы и стандарты'],
                    ['icon' => 'brain', 'title' => 'Открытые формулы с указанием источников.'],
...
<!-- wp:paragraph -->
<p>Фактическое количество материалов может отличаться в зависимости от условий объекта, качества подготовки основания и выбранной технологии работ. Закладывайте запас 5–10%, если инструкция не требует другого.</p>
<!-- /wp:paragraph -->
